...
$db = new  Database();
$con = $db->conectar();
$sql = $con->prepare("SELECT id, nombre, precio FROM productos WHERE activo=1 AND categoria = 'automotive'  ");
$sql->execute();
        ...
        <div class="containerProducts" id="products">
            ...
            <div class="container_title">
                ...
                <nav class="container_title_Nav">
                    <a id="enlaceActivo" href="./productoautomotive.php">Automotive</a>
                    <a href="./productojanitorial.php">Janitorial</a>
            ...
            <div class="container-cards">
                ...
                <div class="card-tarjetas">
                    ...
                    <button class="hidden-btn hidden-btn--a"><a href="detalleproductoautomotive.php?id=<?php echo $row["id"];?>&token=<?php echo hash_hmac("sha1", $row["id"], KEY_TOKEN);?>">View More</a></button> 
                    <button class="hidden-btn " onclick="addProducto(<?php echo $row['id'];?>, '<?php echo hash_hmac('sha1', $row['id'], KEY_TOKEN);?>')">Add to Car</button>
                    </div>
