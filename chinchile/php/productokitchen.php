...
$db = new  Database();
$con = $db->conectar();
$sql = $con->prepare("SELECT id, nombre, precio FROM productos WHERE activo=1 AND categoria = 'kitchen'  ");
$sql->execute();
        ...
        <div class="containerProducts" id="products">
            ...
            <div class="container_title">
                ...
                <nav class="container_title_Nav">
                    ...
                    <a id="enlaceActivo" href="./productokitchen.php">Kitchen</a>
            ...
            <div class="container-cards">
                ...
                <div class="card-tarjetas">
                    ...
                    <button class="hidden-btn hidden-btn--a"><a href="detalleproductokitchen.php?id=<?php echo $row["id"];?>&token=<?php echo hash_hmac("sha1", $row["id"], KEY_TOKEN);?>">View More</a></button>
